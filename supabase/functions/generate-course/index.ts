...
3. "image_text" — картинка + текст (ВАЖНО: добавь описание для генерации изображения!):
{ 
  "type": "image_text", 
  "content": "Текст под картинкой",
  "imageDescription": "Детальное описание изображения для AI-генерации, например: традиционная китайская чайная церемония гунфу ча, фотореалистичный стиль, чайный столик с глиняным чайником и пиалами"
}
...
- Добавляй НЕ БОЛЕЕ 5-8 блоков image_text на ВЕСЬ курс
- Для каждого image_text ОБЯЗАТЕЛЬНО добавь поле "imageDescription" с детальным описанием
- Описания должны быть конкретными и визуальными (что именно изобразить)
- Стиль: фотореализм ИЛИ традиционная китайская акварель/тушь
