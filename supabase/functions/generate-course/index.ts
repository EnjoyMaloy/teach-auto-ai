...
7. БЛОК 10 — "design" ИТОГИ: heading + text + badge-и навыков
...
- После heading/text ОБЯЗАТЕЛЬНО добавь: image, table, badge или divider
- ❌ ПЛОХО: heading → text → text → text
- ✅ ХОРОШО: heading → text → image → text → badge
- ✅ ХОРОШО: heading → image → text → table
- ✅ ХОРОШО: badge → heading → text → divider → text → image

## ВИЗУАЛЬНОЕ РАЗНООБРАЗИЕ:
- Каждый design блок должен иметь хотя бы 1 визуальный элемент: image, table, или badge
...
6. БЛОКИ 8-9 = теория (design с контентом)
7. БЛОК 10 = design ИТОГИ (heading "Отлично!" + text + badge-и навыков)
