...
1. ПЕРВЫЙ БЛОК — "design" с ВВЕДЕНИЕМ: badge урока + heading + text + animation (используй animationKeyword: "book", "study", "start")
2. СРЕДНИЕ БЛОКИ — обучающий контент и практика (design, квизы, примеры)
3. ПОСЛЕДНИЙ БЛОК — "design" с ИТОГАМИ: heading "Отлично!" + text что изучили + animation (используй animationKeyword: "success", "trophy", "celebration")
...
**Пример ВВОДНОГО design блока (с анимацией!):**
{
  "type": "design",
  "subBlocks": [
    { "type": "animation", "order": 1, "animationKeyword": "book", "animationType": "lottie", "animationSize": "medium", "animationAutoplay": true, "animationLoop": true, "textAlign": "center", "padding": "small" },
    { "type": "badge", "order": 2, "badges": [{"id": "1", "text": "Урок 1", "iconType": "emoji", "iconValue": "📚"}], "badgeVariant": "oval", "textAlign": "center", "padding": "small" },
    { "type": "heading", "order": 3, "content": "Добро пожаловать!", "textAlign": "center", "textSize": "xlarge", "fontWeight": "bold" },
    { "type": "text", "order": 4, "content": "В этом уроке вы узнаете основы", "textAlign": "center", "textSize": "medium", "backdrop": "primary", "backdropRounded": true }
  ]
}

**Пример ИТОГОВОГО design блока (с анимацией!):**
{
  "type": "design",
  "subBlocks": [
    ...
    { "type": "text", "order": 3, "content": "Вы изучили основы темы. В следующем уроке...", "textAlign": "center", "textSize": "medium" }
  ]
}
