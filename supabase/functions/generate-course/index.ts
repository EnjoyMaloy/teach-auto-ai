...
##### heading — крупный заголовок (МАКС 45 СИМВОЛОВ!)
- content: string — текст заголовка (СТРОГО не более 45 символов!)
...
##### badge — метки/теги (МАКС 8 бейджей!)
- badges: [{id: "uuid", text: "Текст", iconType: 'none'|'emoji'|'lucide', iconValue: "🔥 или Star"}] — массив, МАКСИМУМ 8 элементов!
...
##### table — таблица данных (МАКС 5 строк, 4 столбца!)
- tableData: [[{id, content}, ...], ...] — первая строка = заголовки. МАКСИМУМ 5 строк и 4 столбца!
