...
const dbSlideToSlide = (row: any): Slide => ({
  ...
  explanationPartial: row.explanation_partial,
  hints: row.hints as SlideHint[] | undefined,
  blankWord: row.blank_word,
  matchingPairs: row.matching_pairs as { id: string; left: string; right: string }[] | undefined,
      ...
      for (const lesson of course.lessons) {
        ...
        for (const slide of lesson.slides) {
          ...
          const slideData = {
            ...
            matching_pairs: slide.matchingPairs as any,
