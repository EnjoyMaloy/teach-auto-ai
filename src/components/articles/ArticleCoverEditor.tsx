  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="article-action-hover inline-flex h-9 w-full items-center justify-center gap-1.5 rounded-xl border border-border bg-background px-3 text-sm font-semibold text-foreground"
      >
