    ...
    <>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div 
          ...
          style={{ background: 'hsl(270 60% 45% / 0.6)' }}
        />
        <div 
          ...
          style={{ background: 'hsl(280 55% 50% / 0.5)' }}
        />
        <div 
      ...
      <div 
        ...
        style={{ background: 'radial-gradient(ellipse 100% 80% at 50% 100%, hsl(270 60% 55% / 0.25), transparent 60%)' }}
      />
    </>
  );
};
