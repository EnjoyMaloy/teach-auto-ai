      ...
      <nav className="flex-1 p-4 bg-[#f7f7f8]">
        <ul className="space-y-1">
          ...
          return <li key={item.path}>
                <button onClick={() => navigate(item.path)} style={{ fontFamily: "'TT Commons', sans-serif" }} className={cn("w-full flex items-center gap-3 px-4 py-3 rounded-sm text-base font-normal transition-all duration-200", isActive ? "bg-[#a66cff] text-white hover:bg-[#924CFE]" : "text-[#464646] hover:bg-[#EBE9EA]")}>
