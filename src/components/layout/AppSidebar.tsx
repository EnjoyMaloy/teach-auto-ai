      ...
      <nav className="flex-1 p-4 bg-[#f7f7f8]">
        <ul className="space-y-1">
          ...
          return <li key={item.path}>
            ...
            }} className={cn("w-full flex items-center gap-3 px-4 py-3 rounded-[5px] transition-all duration-200 text-sm font-medium", isActive ? "bg-[#a66cff] text-white hover:bg-[#924CFE]" : "text-[#464646] hover:bg-[#EBE9EA]")}>
