    ...
    // Design block with ALL sub-block types
    {
      ...
      subBlocks: [
        ...
        // Text - подложка Light с форматированием
        {
          ...
          type: 'text',
          order: 7,
          content: '<p><strong>Light</strong>: <mark>маркер</mark>, <u>подчёркивание</u>, <span data-wavy="true">волнистая</span></p>',
          textSize: 'medium',
          textAlign: 'center',
          backdrop: 'light',
        ...
        // Text - подложка Dark с форматированием
        {
          ...
          type: 'text',
          order: 8,
          content: '<p><strong>Dark</strong>: <mark>маркер</mark>, <u>подчёркивание</u>, <span data-wavy="true">волнистая</span></p>',
          textSize: 'medium',
          textAlign: 'center',
          backdrop: 'dark',
          backdropRounded: true,
        ...
        // Text - подложка Primary с форматированием
        {
          ...
          type: 'text',
          order: 9,
          content: '<p><strong>Primary</strong>: <mark>маркер</mark>, <u>подчёркивание</u>, <span data-wavy="true">волнистая</span></p>',
          textSize: 'medium',
          textAlign: 'center',
          backdrop: 'primary',
          backdropRounded: true,
        ...
        // Text - подложка Blur с форматированием
        {
          ...
          type: 'text',
          order: 10,
          content: '<p><strong>Blur</strong>: <mark>маркер</mark>, <u>подчёркивание</u>, <span data-wavy="true">волнистая</span></p>',
          textSize: 'medium',
          textAlign: 'center',
          backdrop: 'blur',
          backdropRounded: true,
