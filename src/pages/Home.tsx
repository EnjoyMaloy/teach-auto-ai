        ...
        <div className="w-full max-w-2xl bg-card border border-border rounded-2xl p-2 shadow-2xl transition-all">
          <div className="flex items-start gap-3 px-4 py-3">
            <textarea
              ...
              className="flex-1 bg-transparent text-foreground placeholder:text-muted-foreground/60 resize-none outline-none text-[15px] min-h-[24px] max-h-[120px]"
              rows={1}
              style={{ height: 'auto' }}
              onInput={(e) => {
          ...
          <div className="flex items-center justify-between px-4 py-2 border-t border-border/50">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button 
                      disabled
                      className="w-8 h-8 rounded-lg bg-muted/50 flex items-center justify-center opacity-50 cursor-not-allowed hover:bg-muted transition-colors"
                    >
                      <Plus className="w-4 h-4 text-muted-foreground/50" />
                    </button>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="bg-card border-border text-muted-foreground text-xs">
                    Прикрепить файл
                  </TooltipContent>
                </Tooltip>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button 
                      disabled
                      className="h-8 px-3 rounded-lg bg-muted/50 flex items-center gap-1.5 opacity-50 cursor-not-allowed hover:bg-muted transition-colors"
                    >
                      <Gauge className="w-3.5 h-3.5 text-muted-foreground/50" />
                      <span className="text-[12px] text-muted-foreground/50">Сложность</span>
                    </button>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="bg-card border-border text-muted-foreground text-xs">
                    Скоро
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      <span className="text-[12px] text-muted-foreground/50">Дизайн</span>
                    </button>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="bg-card border-border text-muted-foreground text-xs">
                    Скоро
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      ...
                      <span className="text-[12px] text-muted-foreground/50">Маскот</span>
                    </button>
                  </TooltipTrigger>
                  <TooltipContent side="top" className="bg-card border-border text-muted-foreground text-xs">
                    Скоро
            ...
            >
              {isGenerating ? (
                <Loader2 className="w-4 h-4 text-background/50 animate-spin" />
              ) : (
                <ArrowUp className="w-4 h-4 text-background" strokeWidth={2.5} />
              )}
            </button>
          </div>
        </div>
