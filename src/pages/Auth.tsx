...
import AcademyLogo from '@/components/layout/AcademyLogo';
...
const Auth: React.FC = () => {
  ...
  return <div className="min-h-screen flex flex-col lg:flex-row bg-white relative">
      ...
      <div className="w-full flex justify-center lg:justify-start lg:absolute lg:top-6 lg:left-16 xl:left-24 pt-14 pb-8 lg:pt-0 lg:pb-0 z-10">
        <AcademyLogo className="h-24 sm:h-28 lg:h-8" />
      </div>

      {/* Left side - Form */}
      <div className="flex-1 flex flex-col justify-center px-4 sm:px-8 lg:px-16 xl:px-24 pb-8 lg:py-0">
