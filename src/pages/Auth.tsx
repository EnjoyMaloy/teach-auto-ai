      ...
      <div className="flex-1 flex flex-col justify-center px-8 lg:px-16 xl:px-24">
        <div className="w-full max-w-[400px] mx-auto">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 bg-white border-gray-200 hover:bg-gray-50 text-gray-700 font-normal"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`h-11 bg-white border-gray-200 focus:border-gray-300 focus:ring-0 ${errors.email ? 'border-red-400' : ''}`}
              />
              {errors.email && (
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`h-11 bg-white border-gray-200 focus:border-gray-300 focus:ring-0 ${errors.password ? 'border-red-400' : ''}`}
              />
              {errors.password && (
